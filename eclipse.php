...
<title> Developing with the Eclipse IDE - HP webOS Developer Center</title>			<link rel="shortcut icon" href="https://web.archive.org/web/20130130211140im_/https://developer.palm.com/content/typo3conf/ext/palm_template/icons/favicon.ico" type="application/x-empty; charset=binary">
...
<p class="bodytext">This document contains the following sections: </p><ul class="def-list"><li>     <a href="#InstallingEclipsewiththeSDK-InstallingEclipseandthePlugIns">Installing Eclipse and the webOS Plug-In     </a>   </li>      <li>     <a href="#InstallingEclipsewiththeSDK-InstallingAptanaPlugIn">Installing the Aptana Plug-In     </a>   </li>      <li>     <a href="#InstallingEclipsewiththeSDK-UsingEclipsewiththePlugIns">Using Eclipse with the Plug-Ins     </a>   </li>      <li>     <a href="#InstallingEclipsewiththeSDK-StayUpdated">Stay Updated     </a>   </li>      <li>     <a href="#InstallingEclipsewiththeSDK-dev_mode">Enabling Developer Mode     </a>   </li>  </ul></div><a id="c19202"></a><h2>Installing Eclipse and the webOS Plug-In </h2><div class="csc-textpic-text"><p class="bodytext">This section describes how to install and update Eclipse. </p></div><a id="c19212"></a><div class="note notes"><div class="inner"> 						<div class="content"> 							<h4>Note:</h4> 							 							<p>If you are using an earlier version of Eclipse, you must upgrade to Eclipse 3.5 at minimum to get the new plug-ins for webOS development.</p> 						</div> 					</div></div>
<a id="c19222"></a><h5>Install Eclipse   </h5><div class="csc-textpic-text"><ol><li>Download the latest version of Eclipse <a href="http://eclipse.org/downloads/" target="_blank">here</a>. The correct version is Eclipse IDE for JavaScript Web Developers. Download the appropriate version for your operating system and extract to any location. Eclipse will run from the extracted folder.</li><li>Start Eclipse.</li>      <li>When prompted for a workspace location, accept the default (     /home/YOUR_USER_NAME/workspace     )        </li>  </ol></div><a id="c19232"></a><div class="note notes"><div class="inner"> 						<div class="content"> 							<h4>Note:</h4> 							 							<p>The workspace location must be an absolute path with no spaces.</p> 						</div> 					</div></div>
<a id="c19242"></a><h5>Find and install updates   </h5><div class="csc-textpic-text"><ol><li>Select      <strong>Help &gt; Install New Software</strong>.</li>      <li>In the <strong>Available Software</strong> dialog, click      <strong>Add...</strong></li>      <li>In the      <strong>Location     </strong> field, type&nbsp;http://<?php echo $_SERVER['HTTP_HOST']; ?>/EclipsePlugin/site.xml, and then click      <strong>OK.</strong> (If you are unable to connect to this site, see the Local download instructions below.)<strong> </strong></li>      <li>Open the new site in the list, expand      <strong>Palm webOS SDK</strong>, and the click the      <strong>Palm webOS SDK     </strong> check box.</li>      <li>Click      <strong>Install... &nbsp; &nbsp;&nbsp;</strong> and accept the license agreements.</li><li>When the <strong>Install</strong> dialog comes up, make sure Palm webOS SDK is selected, and click <strong>Finish</strong>.</li>      <li>Restart Eclipse when prompted.</li>  </ol></div>
<a id="c19252"></a><h2>Installing the Aptana Plug-In </h2><div class="csc-textpic-text"><p class="bodytext">To improve the development experience, HP recommends installing the    <a href="http://www.aptana.com/">Aptana Studio   </a> plug-in.  The Aptana plug-in provides HTML, JavaScript, and CSS functionality to Eclipse.  
</p>
<p class="bodytext">To install Aptana after installing Eclipse, go to    <a href="http://www.aptana.com/" target="_blank">www.aptana.com</a> and Click on the &quot;Download Aptana Studio 3&quot; link. On the &quot;Download&quot; page, select &quot;Eclipse Plug-in Version&quot; and then follow the instructions given.<a name="InstallingEclipsewiththeSDK-UsingEclipsewiththePlugIns" title="InstallingEclipsewiththeSDK-UsingEclipsewiththePlugIns"></a>   </p></div>
<a id="c19262"></a><h2>Using Eclipse with the Plug-Ins </h2><div class="csc-textpic-text"><p class="bodytext">This section describes how to run Eclipse and use the debug launch configuration. </p></div>
<a id="c19272"></a><h3>Starting Eclipse </h3><div class="csc-textpic-text"><p class="bodytext">Follow these instructions to start Eclipse:  </p><ul><li>Linux: At the command prompt, type      eclipse</li>      <li>Mac: In the Eclipse folder (inside the Applications folder), double-click      <strong>Eclipse</strong></li>      <li>Windows: Find and open          eclipse.exe      (its location depends on where you installed Eclipse)</li>  </ul></div>
<a id="c19282"></a><h3>Selecting the webOS Perspective </h3><div class="csc-textpic-text"><p class="bodytext">Eclipse has several perspectives, or views, from which to choose. You want to work in the webOS perspective.</p></div>
<a id="c19292"></a><h5>Select the perspective   </h5><div class="csc-textpic-text"><ol><li>Select      <strong>Window &gt; Open Perspective &gt; Other...</strong></li>      <li>Select      <strong>webOS</strong>, and then click      <strong>OK</strong></li>  </ol></div>
<a id="c19302"></a><h3>Generating a webOS Application </h3><div class="csc-textpic-text"><p class="bodytext">This section includes the following procedures: </p><ul><li>     <a href="#InstallingEclipsewiththeSDK-CreateApp">Create a new webOS application     </a>   </li>      <li>     <a href="#InstallingEclipsewiththeSDK-AddScene">Add a scene to the application     </a>   </li>      <li>     <a href="#InstallingEclipsewiththeSDK-StartApp">Start the application     </a>   </li>      <li>     <a href="#InstallingEclipsewiththeSDK-DebugApp">Debug an application     </a>   </li>  </ul></div><a id="c19312"></a><div class="note notes"><div class="inner"> 						<div class="content"> 							<h4>Note:</h4> 							 							<p>You can also use the New Mojo application icon in the Workbench toolbar to create an application or scene.</p> 						</div> 					</div></div>
...
<div class="col-aside">
    <div class="sidebox">
        ...
        <ol class="article-nav">
            <li class="current last"><a href="/web/20131031072322/https://developer.palm.com/content/resources/develop/developing_with_the_eclipse_ide.html" target="_top">Developing with the Eclipse IDE</a>
            <ol class="level-1"><li><a href="#c19202" target="_top">Installing Eclipse and the webOS Plug-In</a></li>
            ...
            <li><a href="#c19262" target="_top">Using Eclipse with the Plug-Ins</a></li>
            <li><a href="#c19272" target="_top">Starting Eclipse</a></li>
            <li><a href="#c19282" target="_top">Selecting the webOS Perspective</a></li>
            ...
            <li><a href="#c19412" target="_top">Enable Developer mode, webOS 1.0-1.4.5</a></li>
            <li class="last"><a href="#c19422" target="_top">Enable Developer mode, webOS 2.0 and 3.0</a></li></ol></li></ol>
    </div>
</div>
