    ...
    <div id="content" class="col-content">
      <div class="default-content article-content">
        ...
        <div class="csc-textpic-text">
          ...
          now runs&nbsp;on Virtualbox 4.0 and&nbsp;4.1.</p>
        ...
        <div class="csc-textpic-text">
          ...
          supports&nbsp;VirtualBox 4.0 and&nbsp;4.1.</p>
        ...
        <div class="csc-textpic-text">
          ...
          now&nbsp;supports VirtualBox 4.0 and&nbsp;4.1.</p>
      ...
      <div class="sidebox">
        ...
        <ol class="article-nav">
          <li class="current last">
            ...
            <ol class="level-1">
              <li><a href="#c23272" target="_top">Installing the SDK and PDK on a Windows
              PC</a></li>

              <li><a href="#c23352" target="_top">Installing the SDK and PDK on a
              Mac</a></li>

              <li><a href="#c28522" target="_top">Installing the SDK on Ubuntu
              Linux</a></li>

              <li class="last"><a href="#c39896" target="_top">Other Emulator
              Images</a></li>
            </ol>
          </li>
        </ol>
